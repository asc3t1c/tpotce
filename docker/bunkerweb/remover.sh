...
docker rmi -f mariadb:11.4 bunkerity/bunkerweb:1.6.0 bunkerity/bunkerweb-scheduler:1.6.0 bunkerity/bunkerweb-ui:1.6.0 tecnativa/docker-socket-proxy:nightly
